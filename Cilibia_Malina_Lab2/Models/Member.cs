...
namespace Cilibia_Malina_Lab2.Models
{
    public class Member
    {
        ...
        [RegularExpression(@"^0([0-9]{3})[-. ]?([0-9]{3})[-. ]?([0-9]{3})$", ErrorMessage = "Telefonul trebuie să fie de forma '0722-123-123' sau '0722.123.123' sau '0722 123 123' si sa inceapa cu 0")]
